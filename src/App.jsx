...
function App() {
  ...
  const [graduationYearInputValue, setGraduationYearInputValue] = useState(2023);
    ...
    <div className="App pt-20">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div>
          <label>
            Full Name
            <input name="fullName" type="text" placeholder="Full Name" value={nameInputValue} onChange={handleNameChange}/>
          </label>

          <label>
            Profile Image
            <input name="image" type="url" placeholder="Profile Image" value={imageInputValue} onChange={handleImageChange}/>
          </label>

          <label>
            Phone
            <input name="phone" type="tel" placeholder="Phone" value={phoneInputValue} onChange={handlePhoneChange}/>
          </label>

          <label>
            Email
            <input name="email" type="email" placeholder="Email" value={emailInputValue} onChange={handleEmailChange}/>
          </label>
        </div>
        ...
        <div>
          <label>
            Program
            <select name="program" value={programInputValue} onChange={handleProgramChange}>
          ...
          <label>
            Graduated
            <input name="graduated" type="checkbox" checked={graduatedInputValue} onChange={handleGraduatedChange} />
          </label>
